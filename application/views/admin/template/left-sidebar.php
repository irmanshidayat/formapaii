    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <!-- data peserta -->
                <li>
                    <a href="<?= base_url('admin/data_peserta') ?>">Data Peserta</a>
                </li>

                <!-- Tambahkan item menu Ekspor di sini -->
                <li>
                    <a href="<?= base_url('ekspor/ekspor_data') ?>" class="waves-effect"><i class="dripicons-upload"></i><span> Ekspor </span></a>
                </li>
                <li>
